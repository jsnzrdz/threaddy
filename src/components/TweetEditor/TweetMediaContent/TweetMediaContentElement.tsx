    ...
    return (
        <div className="flex border-gray-600 border border-dashed rounded-md h-32 w-full">
            <div className="flex-grow h-full flex justify-center items-center">
            {
                ...
                :
                <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="none" className="size-10 cursor-pointer">
                    <path fill="white" fillRule="evenodd" d="M9 17a1 1 0 102 0v-6h6a1 1 0 100-2h-6V3a1 1 0 10-2 0v6H3a1 1 0 000 2h6v6z" />
                </svg>
            }
            </div>
        </div>
