            ...
            <div className="flex flex-col gap-2 absolute -right-6 bottom-3 cursor-pointer text-sky-600">
                {
                    ...
                    tweet.threadPosition === 0 ?
                        "" :
                        <svg data-testid="arrow-up" onClick={() => onMoveTweet(tweet.threadPosition, tweet.threadPosition - 1)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-4">
                ...
                }
                {
                    ...
                    threadLength === tweet.threadPosition + 1 ?
                        ""
                        :
                        <svg data-testid="arrow-down" onClick={() => onMoveTweet(tweet.threadPosition, tweet.threadPosition + 1)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-4">
